# Generated by Django 4.1.2 on 2022-11-21 07:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aktyorlar', models.ManyToManyField(to='netflix.aktyor')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
                ...
                ('kino', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='netflix.kino')),
